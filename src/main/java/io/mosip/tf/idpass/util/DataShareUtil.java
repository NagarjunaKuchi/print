...
import io.mosip.tf.idpass.dto.DataShareResponseDto;
import io.mosip.tf.idpass.dto.ErrorDTO;
import io.mosip.tf.idpass.exception.ApiNotAccessibleException;
import io.mosip.tf.idpass.exception.DataShareException;
	...
	public DataShare getDataShare(byte[] data, String policyId, String partnerId)
		...
		if (responseObject != null && responseObject.getErrors() != null && !responseObject.getErrors().isEmpty()) {
			...
			if (e.getCause() instanceof HttpClientErrorException) {
				...
				throw new io.mosip.tf.idpass.exception.ApiNotAccessibleException(
