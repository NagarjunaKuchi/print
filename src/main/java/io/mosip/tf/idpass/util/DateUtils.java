...
import io.mosip.tf.idpass.constant.DateUtilConstants;
import io.mosip.tf.idpass.exception.IllegalArgumentException;
...
public final class DateUtils {
	...
	public static LocalDateTime parseUTCToLocalDateTime(String utcDateTime, String pattern) {
		...
		try {
			...
			throw new io.mosip.tf.idpass.exception.ParseException(
	...
	public static Date parseToDate(String dateString, String pattern) {
		if (Objects.isNull(dateString) || Objects.isNull(pattern)) {
			throw new io.mosip.tf.idpass.exception.NullPointerException(
